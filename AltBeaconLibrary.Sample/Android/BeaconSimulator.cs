...
namespace AltBeaconLibrary.Sample.Droid
{
	public class BeaconSimulator : Java.Lang.Object, IBeaconSimulator
	{
		...
		public void CreateBasicSimulatedBeacons()
		{
            ...
            var beacon5 = new AltBeacon.Builder().SetId1("00110001-0010-0111-1010-000110110111")
                .SetId2("4").SetId3("0").SetRssi(-55).SetTxPower(-55).Build();


			_beacons.AddRange(new [] { beacon1, beacon2, beacon3, beacon4,beacon5 });
		}
	}
}
